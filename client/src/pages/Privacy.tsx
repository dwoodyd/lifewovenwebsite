...
const sections: LegalSection[] = [
  {
    ...
    body: [
      "When you create an account or choose a membership tier, we collect the information you give us directly, such as your name and email address.",
  ...
  },
  {
    ...
    body: [
      "We use your information to provide and personalize the Lifewoven experience, respond to support requests, send important account and service messages, and improve our tools. We may process content in optional AI features you choose to use, but we do not use personal content to train general AI models without your explicit consent.",
